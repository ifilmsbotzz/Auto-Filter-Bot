...
# Bot information
API_ID = environ.get('API_ID', '28337087')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7110812837:AAFZ5s2ZAbOBt0PDKzKE6G2h_U0LAGIouSc')
if len(BOT_TOKEN) == 0:
...
# Bot pics
PICS = (environ.get('PICS', 'https://graph.org/file/ebecd8e899b1462d1a762.jpg')).split()

# Bot Admins
ADMINS = environ.get('ADMINS', '1341058877 6524026535')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002060503760')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://nyashs:Yash123147@cluster0.i8yygey.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/ebecd8e899b1462d1a762.jpg')

# for stream
IS_STREAM = is_enabled('IS_STREAM', True)
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002052410963")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://auto-filter-bot-xzac.onrender.com/")
if len(URL) == 0:
